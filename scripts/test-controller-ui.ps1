...
foreach ($requiredText in @(
    ...
    'Fixed controller-only emergency recovery',
    'Hold View + Menu for 750 ms, then newly press and hold LT for 1.25 seconds.',
    'AutomationProperties.AutomationId="EnableVirtualControllerRemapping"',
    'AutomationProperties.HelpText="Validation only. ViGEm is retired upstream;',
    'all non-injected F11/F12 keys are captured globally while enabled.',
    'AutomationProperties.AutomationId="NavigationCaptureUpdate"',
    'AutomationProperties.AutomationId="NavigationCaptureLabel"',
    'AutomationProperties.AutomationId="NavigationCaptureSubtitle"',
    'ScrollViewer.HorizontalScrollBarVisibility="Disabled"',
    'Capture Armoury M1/M2',
    'Snapshot M1/M2 state · read-only',
    'x:Name="RearButtonSnapshotButton"',
    'AutomationProperties.AutomationId="RearButtonSnapshotButton"',
